...
When not all runs managed to find the target value, the statistics hold for the simulated algorithm that restarts after B iterations, where B is the maximal number of function evaluations that an algorithm is allowed to perform per iteration.
