...
observe({
  ...
  updateSelectInput(session, 'FCEPDF.Bar.Algs', choices = algIds_, selected = selected_alg)
  updateSelectInput(session, 'FCEPDF.Hist.Algs', choices = algIds_, selected = selected_alg)
  updateSelectInput(session, 'RTPMF.Bar.Algs', choices = algIds_, selected = selected_alg)
  updateSelectInput(session, 'RTPMF.Hist.Algs', choices = algIds_, selected = selected_alg)
