fv_overview_box <- function(width = 12, collapsible = T, collapsed = T) {
  box(title = HTML('<p style="font-size:120%;">Data Overview</p>'),
      ...
      sidebarPanel(
        ...
        hr(),
        selectInput('FCESummary.Overview.Format', 'Format', choices = table_formats, selected = table_format_default),
...
fv_stats_box <- function(width = 12, collapsible = T, collapsed = T) {
  box(title = HTML('<p style="font-size:120%;">Target Statistics at Chosen Budget Values</p>'),
      ...
      sidebarPanel(
        ...
        hr(),
        selectInput('FCESummary.Statistics.Format', 'Format', choices = table_formats, selected = table_format_default),
...
fv_sample_box <- function(width = 12, collapsible = T, collapsed = T) {
  box(
    ...
    sidebarPanel(
      ...
      hr(),
      selectInput('FCESummary.Sample.FileFormat', 'File-Format', choices = table_formats, selected = table_format_default),
